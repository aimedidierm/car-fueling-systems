...
<div class="p-4 sm:ml-64">
    <div class="flex justify-between">
        <a href="#" class="flex items-center pl-2.5 mb-5">
            <span class="self-center text-xl font-semibold whitespace-nowrap">List of all clients</span>
        </a>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                        <button data-modal-target="editModal" data-modal-toggle="editModal"
                            ...
                            type="button" onclick="editItem({{$client}})">
                            Edit
                        </button>
                    </td>
                </tr>
        ...
        <div id="editModal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative w-full max-w-2xl max-h-full">
                <div
                    ...
                    <div class="p-6 space-y-6">
                        <form class="space-y-4 md:space-y-6" method="POST" action="/admin/clients">
                            @csrf
